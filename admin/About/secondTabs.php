...
<?php
	session_start();
		...
		include '../../db.php';
		$sql1 = "SELECT * FROM aboutText WHERE id=4";
		$query1 = mysqli_query($connect, $sql1);
		$row1 = mysqli_fetch_assoc($query1);

	?>
	<section id="mainText">
		<h3>Change Second Tables</h3>
		<p>First</p>
	...
	<?php
		if(isset($_POST['subm'])){
			...
			$sql1 = "UPDATE aboutText SET head='$head',span='$span',smallText='$smallText',text='$text' WHERE id=4";
			$query1 = mysqli_query($connect, $sql1);

			if($query1){
				header("Location: secondTabs.php");
			}else{
	...
	?>
	<?php
		$sql2 = "SELECT * FROM aboutText WHERE id=5";
	...
	<?php
		...
		if(isset($_POST['submit'])){
			...
			$sql2 = "UPDATE aboutText SET head='$head',span='$span',smallText='$smallText',text='$text' WHERE id=5";
			$query2 = mysqli_query($connect, $sql2);
	...
	<?php
		$sql3 = "SELECT * FROM aboutText WHERE id=6";
	...
	<?php
		...
		if(isset($_POST['send'])){
			...
			$sql3 = "UPDATE aboutText SET head='$head',span='$span',smallText='$smallText',text='$text' WHERE id=6";
			$query3 = mysqli_query($connect, $sql3);
