...
// 		if(scroll > $('#about .logo').offset().top - $(window).height() / 2.4){
// 			$(".height").addClass('heightMenu');
// 			$("#home .menuHome").addClass('menuBar');
...
function homeExtra(){
	...
	$(".drop").mouseenter(function() {
		...
		$(".drop .blog").hide();
		$(".drop .ecommerce").hide();
		$(".drop .a").eq(0).mouseenter(function() {
			$(".drop .homePages").show(300);
		});
		$(".drop .a").eq(0).mouseleave(function() {
			$(".drop .homePages").hide(300);
		});
		$(".drop .a").eq(1).mouseenter(function() {
			$(".drop .blog").show(300);
		});
		$(".drop .a").eq(1).mouseleave(function() {
			$(".drop .blog").hide(300);
		});
		$(".drop .a").eq(2).mouseenter(function() {
			$(".drop .ecommerce").show(300);
		});
		$(".drop .a").eq(2).mouseleave(function() {
